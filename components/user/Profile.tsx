...
export const Profile = () => {
  ...
  return (
    <div className="p-4 relative">
      <div className="text-center mb-4 absolute -top-4 right-1/2 transform translate-x-1/2">
        <a href="#" className="block relative border-2 border-gray-400 rounded-lg">
          <img alt="profil" src="/images/profile.jpg" className="mx-auto object-cover rounded-lg h-40 w-40  border-2 border-white dark:border-gray-800" />
        </a>
      </div>
      <div className="bg-gray-100 rounded-lg shadow px-8 py-4 pt-40">
        <div className="text-center">
          ...
          <p className="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
            Charlie, born April 19, 1977 in Japan, is an imitator.
          </p>
        </div>
